$(document).ready(function() {
    $("#button").click(function() {
        ...
        tableString = '<div class="row justify-content-center"><div class = "col" style="table;">' + createTableHeaders();
        ...
        tableString = tableString + '</div></div>';
    ...
    $('#gradesTable').on('click', 'div', function() {
        $this = $(this);

        if ($this.hasClass('yearrow')) {
            if ($this.hasClass('open')) {
                $this.toggleClass('open').nextUntil('.yearrow', 'div').hide("fast");
            } else {
                $this.toggleClass('open').nextUntil('.yearrow', 'div:not(.courserow)').slideToggle("fast");
            }
        } else if ($this.hasClass('semesterrow')) {
            $this.nextUntil('.semesterrow', 'div:not(.yearrow)').slideToggle("fast");
        }
    });
...
function createCumulativeRow(Units, Credits, grade) {
    return '<div class="cumulativerow row justify-content-center"><div class="cell col" style="text-align: center; width: 819px;">Cumulative</div><div class="cell col" style="text-align: center; width:91px;">' + Units.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + Credits.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + grade.toString() + '</div></div>';
}

function createYearRow(TimePeriod, Units, Credits, grade) {
    return '<div class="yearrow row justify-content-center"><div class="cell col" style="text-align: center; width: 819px;">' + TimePeriod.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + Units.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + Credits.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + grade.toString() + '</div></div>';
}

function createSemesterRow(TimePeriod, Units, Credits, grade) {
    return '<div class="semesterrow row justify-content-center"><div class="cell col" style="text-align: center; width: 819px;">' + TimePeriod.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + Units.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + Credits.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + grade.toString() + '</div></div>';
}

function createCourseRow(Course, Code, Units, Credits, grade) {
    return '<div class="courserow row justify-content-center"><div class="cell col" style="text-align: center; width:819px;">' + (Code.toString() + ': ' + Course.toString()) + '</div><div class="cell col" style="text-align: center; width:91px;">' + Units.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + Credits.toString() + '</div><div class="cell col" style="text-align: center; width:91px;">' + grade.toString() + '</div></div>';
}
